...
class PaymentsPDF extends AbstractPDFExporter
{
    /**
     * @var array
     */
    ...
    function __construct()
    {
        ...
        $this->init(
            'Planilla de Pago', // title
            'Planilla de Pago Oficial', // subject
            array(
                'planilla',
                'pagos'
            )
    ...
    public function export(array $data)
    {
        ...
        $this->setHeaderAndFooterData('Planilla de Pago', $description);
